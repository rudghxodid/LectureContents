    ...
    <div>
        ...
        <v-container fluid>
            ...
            <v-layout row wrap>
                ...
                <v-flex xs4 md3 class="green white--text">
                    <div>{{ message }}</div>
                </v-flex>
                <v-flex xs4 md3 class="green white--text">
                    <div>{{ message }}</div>
        ...
        <v-layout row justify-center>
            <!-- 사용자에게 알림을 제공하거나 중요 정보를 포함해 의사 겾렁을 하도록
            유도하는데 활용 대화상자가 뜨면서 결제할 것인지 취소할 것인지
            어쩔건지 등등에 활용하기 좋음-->
