<template>
    <div class="app">
        ...
        <!-- 반응형 사진 -->
        <div class="row">
            <img class="responsive-img" src="@/assets/img/model-x.jpg">
        </div>
        <!-- 아이콘 기능 -->
        <div>
        ...
        <div class="video-container">
            <iframe width="1200" height="720" src="https://www.youtube.com/embed/LnREi-tsbI0"
        ...
        <!--화면 보여주기 옵션 -->
        <div class="row">
        <img class="circle responscive-img hide-on-small-only" src="@/assets/img/spyder.jpg">
        </div>
        <!-- Grid(깔 맞추기) -->
        <div class="container">
            <div class="row">
        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col s12 m4 12 x13 red">
                    <p>오진다</p>
                    </div>
                    <div class="col s12 m4 18 x16 green">
                    <p>오진다</p>
                    </div>
